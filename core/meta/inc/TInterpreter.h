...
public:
   ...
   virtual Long_t   ClassInfo_GetBaseOffset(ClassInfo_t* /* derived */,
                                            ClassInfo_t* /* base */, void* /* address */ = 0, bool /*isderived*/ = true) const {return 0;}
   ...
   virtual Long_t BaseClassInfo_Offset(BaseClassInfo_t * /* bcinfo */, void* /* address */ = 0 /*default for non-virtual*/, bool /*isderived*/ = true /*default for non-virtual*/) const {return 0;}

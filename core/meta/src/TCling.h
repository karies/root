...
public: // Public Interface
   ...
   virtual Long_t   ClassInfo_GetBaseOffset(ClassInfo_t* derived, ClassInfo_t* base, void * address, bool isDerivedObject) const;
   ...
   virtual Long_t BaseClassInfo_Offset(BaseClassInfo_t* bcinfo, void * address, bool isDerivedObject) const;

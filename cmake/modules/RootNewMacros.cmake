...
function(ROOT_LINKER_LIBRARY library)
  ...
  # convert from unordered_mapDict to G__std_unordered_map
  string(REPLACE "Dict$" "" dictlibstem ${library})
  if(TARGET G__std__${dictlibstem})
    add_dependencies(${library} G__std_${dictlibstem})
  endif()
